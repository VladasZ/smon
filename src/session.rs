...
mod tests {
    ...
    const OVERCOUNT_LINE: &str = "D I A1 0x00F 0x00000 26-07-01~05:40:42.222+00:00~#  TSK1 APP ServiceManager MessageCollectorRegistryComponent.cpp Line 77 : MessageCollectorRegistryComponent::initializeAfterAllRegistryComponents() called, initializing messageCollector~ ";
